package com.hongjiuxin.smartapartment.config;
 ...
 * @Author: mqs
 * @Description:
 * @Date: 上午10:37 2018/3/30
 */
@EnableWebMvc
@EnableSwagger2
@Configuration
@ComponentScan(basePackages = "com.hongjiuxin.smartapartment")
public class SwaggerConfig {

    @Bean
    public Docket buildDocket() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(buildApiInf()).select()
            .apis(RequestHandlerSelectors.basePackage("com.hongjiuxin.smartapartment.controller"))// controller路径
